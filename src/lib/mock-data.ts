...
function ch(id: string, fullName: string, gradeLevel: string, program: Program, school: string, emergencyContactName: string, emergencyPhone: string, allergies: string = 'No'): Chanich {
  return {
